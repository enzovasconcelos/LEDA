 ...
 * @author Adalberto
 */
public class RepositorioProdutoArrayList implements IRepositorio {
	...
	private int procurarIndice(int codigo) {
	        for(int indice = 0; indice < this.produtos.size(); indice++) {
                    if(this.produtos.get(indice).getCodigo() == codigo)
                        return indice;
                }	
                return -1;
	}
	...
	public void remover(int codigo) {
            // TODO: analizar desempenho dessa operação.
